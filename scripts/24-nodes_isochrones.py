...
if __name__ == "__main__":
    ...
    split_nodes = chunker_list(all_nodes, 190)

    aup.log('Starting multiprocessing.')
    # list for multiprocessing
    
    input_list = [(trip_time, prox_measure, projected_crs, nodes, edges, G, db_save, local_save) for input_nodes in split_nodes]
