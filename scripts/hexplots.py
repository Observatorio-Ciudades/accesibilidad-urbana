...
if __name__ == "__main__":
	...
	for city, data in  areas.items():
		...
		try:
			...
			hex_bins = aup.create_hexgrid(area,resolution)
			...
			for amenity_name in amenities:
				hex_new = aup.group_by_hex_mean(nodes,hex_bins,resolution, amenity_name)
